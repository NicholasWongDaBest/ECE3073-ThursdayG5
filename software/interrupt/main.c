...
volatile int * KEY_GPIO = (volatile int *)0x4000050;
...
int main()
{
	alt_putstr("CPU is alive!\n"); // Very lightweight print
	//set up interrupt
	//clear previous interrupt
	*(KEY_GPIO + 3) = 0x0;
	// Below 3 lines of code will be needed to set interrupts
	// 1. set up falling edge triggered interrupts for the counter PIO
	*(KEY_GPIO + 2) = 0x3;
	// 2. set interrupt enable mask bit for counter IRQ level 3 (this is one hot)
